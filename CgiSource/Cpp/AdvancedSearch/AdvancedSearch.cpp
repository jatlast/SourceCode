...
#include "DB_Table_Base/AdvancedSearch_Info.h"
#include "AddJavaScript/AddJavaScript.h"
#include "Connections_Templates/Connections_Templates.h"

void main()
{
	DB_Table_Base * Base_Ptr = new AdvancedSearch_Info("advancedSearch", "");
	bool itWorked = Search_Template(Base_Ptr, "AdvancedSearch.exe");
