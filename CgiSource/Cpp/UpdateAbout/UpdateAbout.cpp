...
#include "DB_Table_Base/About_Info.h"
...
void main()
{
	...
	DB_Table_Base * Base_Ptr = new About_Info("getAboutInfoByNamePassword", "updateAboutInfo");

	bool itWorked = Update_Template(Base_Ptr, "UpdateAbout.exe");
