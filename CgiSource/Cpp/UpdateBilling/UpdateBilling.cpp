...
#include "DB_Table_Base/Billing_Info.h"
...
void main()
{
	...
	DB_Table_Base * Base_Ptr = new Billing_Info("getBillingInfoByNamePassword", "updateBillingInfo");

	bool itWorked = Update_Template(Base_Ptr, "UpdateBilling.exe");
