...
#include "DB_Table_Base/Contact_Info.h"
...
void main()
{
	...
	DB_Table_Base * Base_Ptr = new Contact_Info("getContactInfoByNamePassword", "updateContactInfo");

	bool itWorked = Update_Template(Base_Ptr, "UpdateContact.exe");
