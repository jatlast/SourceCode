...
#include "DB_Table_Base/Personal_Info.h"
...
void main()
{
	...
	DB_Table_Base * Base_Ptr = new Personal_Info("getPersonalInfoByNamePassword", "updatePersonalInfo");

	bool itWorked = Update_Template(Base_Ptr, "UpdatePersonal.exe");
