...
As a new user you have access to a subset of everything our web site has to offer. In order to obtain full access you must become a Gold member.  We will keep you posted as to all new developments and enhancements to the site.
...
INSERT INTO billing_info (user_name,card_type,name_on_card,account_number,expiration_month,expiration_year,is_membership_active,date_membership_expires,bank_ABA_code,bank_account_number) VALUES ('Administrator','4','Administrator','5081810004808146','08','2003','1',GETDATE(),'','')
...
INSERT INTO login_info (user_id,user_name,membership_type,password,password_hint,email,sex,creation_date,last_login,photo_submitted,date_started_paying) VALUES ('1','Administrator',1,'janesays','Anderson','connections.admin@verizon.net','1',GETDATE(),GETDATE(),'0',GETDATE())
