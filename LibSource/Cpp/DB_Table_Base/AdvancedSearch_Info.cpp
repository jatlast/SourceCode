...
AdvancedSearch_Info::AdvancedSearch_Info(const string & get_info_sql, const string & update_info_sql)
{
	...
	DB_Table_Base::DB_Table_Info column8 ("profession"		,	""			,		""			, "Profession"		,	""		   ,			""		,		8 		, NTBSTRINGBIND	,	PROFESSION		);
	DB_Table_Base::DB_Table_Info column9 ("income"			,	""			,		""			, "Income"			,	""		   ,			""		,		9 		, NTBSTRINGBIND	,	INCOME			);
	DB_Table_Base::DB_Table_Info column10("education"		,	""			,		""			, "Education"		,	""		   ,			""		,		10		, NTBSTRINGBIND	,	EDUCATION		);
	DB_Table_Base::DB_Table_Info column11("religion"		,	""			,		""			, "Religion"		,	""		   ,			""		,		11		, NTBSTRINGBIND	,	RELIGION		);
	DB_Table_Base::DB_Table_Info column12("min_age_desired"	,	""			,		""			, "Min Age Desired"	,	""		   ,			""		,		12		, NTBSTRINGBIND	,	MIN_AGE_DESIRED	);
	DB_Table_Base::DB_Table_Info column13("max_age_desired"	,	""			,		""			, "Max Age Desired"	,	""		   ,			""		,		13		, NTBSTRINGBIND	,	MAX_AGE_DESIRED	);
	DB_Table_Base::DB_Table_Info column14("min_height"		,	""			,		""			, "Height"			,	""		   ,			""		,		14		, NTBSTRINGBIND	,	HEIGHT			);
	DB_Table_Base::DB_Table_Info column15("max_height"		,	""			,		""			, "Height"			,	""		   ,			""		,		15		, NTBSTRINGBIND	,	HEIGHT			);
	DB_Table_Base::DB_Table_Info column16("min_weight"		,	""			,		""			, "Weight"			,	""		   ,			""		,		16		, NTBSTRINGBIND	,	WEIGHT			);
	DB_Table_Base::DB_Table_Info column17("max_weight"		,	""			,		""			, "Weight"			,	""		   ,			""		,		17		, NTBSTRINGBIND	,	WEIGHT			);
	DB_Table_Base::DB_Table_Info column18("eyes"			,	""			,		""			, "Eyes"			,	""		   ,			""		,		18		, NTBSTRINGBIND	,	EYES			);
	DB_Table_Base::DB_Table_Info column19("hair"			,	""			,		""			, "Hair"			,	""		   ,			""		,		19		, NTBSTRINGBIND	,	HAIR			);
	DB_Table_Base::DB_Table_Info column20("cook"			,	""			,		""			, "Cook"			,	""		   ,			""		,		20		, NTBSTRINGBIND	,	COOK			);
	DB_Table_Base::DB_Table_Info column21("smoke"			,	""			,		""			, "Smoke"			,	""		   ,			""		,		21		, NTBSTRINGBIND	,	SMOKE			);
	DB_Table_Base::DB_Table_Info column22("drink"			,	""			,		""			, "Drink"			,	""		   ,			""		,		22		, NTBSTRINGBIND	,	DRINK			);
	DB_Table_Base::DB_Table_Info column23("party"			,	""			,		""			, "Party"			,	""		   ,			""		,		23		, NTBSTRINGBIND	,	PARTY			);
	DB_Table_Base::DB_Table_Info column24("political"		,	""			,		""			, "Political"		,	""		   ,			""		,		24		, NTBSTRINGBIND	,	POLITICAL		);
	DB_Table_Base::DB_Table_Info column25("housing_status"	,	""			,		""			, "Housing"			,	""		   ,			""		,		25		, NTBSTRINGBIND	,	HOUSING_STATUS	);
	DB_Table_Base::DB_Table_Info column26("relationship"	,	""			,		""			, "Relationship"	,	""		   ,			""		,		26		, NTBSTRINGBIND	,	PREFER_NOT_TO_SAY);
	DB_Table_Base::DB_Table_Info column27("text_search"		,	""			,		""			, "Text Search"		,	""		   ,			""		,		27		, NTBSTRINGBIND	,	64				);
	DB_Table_Base::DB_Table_Info column28("which_fields"	,	""			,		""			, "Search Fields"	,	""		   ,			""		,		28		, NTBSTRINGBIND	,	 2				);
	DB_Table_Base::DB_Table_Info column29("search_limit"	,	""			,		""			, "Limit"			,	""		   ,			""		,		29		, NTBSTRINGBIND	,	 2				);
	DB_Table_Base::DB_Table_Info column30("sort_order"		,	""			,		""			, "Sort"			,	""		   ,			""		,		30		, NTBSTRINGBIND	,	 1				);
	DB_Table_Base::DB_Table_Info column31("index"			,	""			,		""			, "Index"			,	""		   ,			""		,		31		, NTBSTRINGBIND	,	 4				);
	...
	Vect.push_back(column30);
	Vect.push_back(column31);

	DB_Table_Base::DB_Table_Base_Error_Text = "AdvancedSearch_Info Constructor";

}

void
AdvancedSearch_Info::Print_Current_And_Change( const string & name )
{
	/*
